package com.appytech.businessway.tools.glideUtils;
...
public class GlideRoundedCornersTransformation implements Transformation<Bitmap> {
    ...
    public GlideRoundedCornersTransformation(Context context, int radius, int margin) {
        this(context, radius, margin, CornerType.ALL);
    }

    public GlideRoundedCornersTransformation(BitmapPool pool, int radius, int margin) {
